...
class DegreeTests: XCTestCase {
    static var allTests = [
        ("testConvenienceInitWithRawDoubleValue", testConvenienceInitWithRawDoubleValue),
        ("testConveniencenIntiWithRawFloatValue", testConveniencenIntiWithRawFloatValue),
        ("testConveniencenIntiWithRawCGFloatValue", testConveniencenIntiWithRawCGFloatValue),
        ("testConvenienceInitWithRadianAngle", testConvenienceInitWithRadianAngle),
        ("testNormalization", testNormalization),
        ("testNormalization2", testNormalization2),
        ("testNormalization3", testNormalization3),
        ("testNormalization4", testNormalization4),
        ("testNormalizeValueIsPositive", testNormalizeValueIsPositive),
        ("testNormalizeValueIsPositive2", testNormalizeValueIsPositive2),
        ("testNormalized", testNormalized),
        ("testNormalizedValueIsPositive", testNormalizedValueIsPositive),
        ...
        ("testValueMultiplicationOperationWithFloat", testValueMultiplicationOperationWithFloat),
        ("testValueMultiplicationOperationWithCGFloat", testValueMultiplicationOperationWithCGFloat),
