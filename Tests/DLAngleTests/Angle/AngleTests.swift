...
class AngleTests: XCTestCase {
    static var allTests = [
        ("testRawValueConstructor", testRawValueConstructor),
        ("testFloatConstructor", testFloatConstructor),
        ("testDoubleConstructor", testDoubleConstructor),
        ("testCGFloatConstructor4", testCGFloatConstructor4)
    ]
