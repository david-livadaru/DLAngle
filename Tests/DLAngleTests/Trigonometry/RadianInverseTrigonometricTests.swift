...
class RadianInverseTrigonometricTests: XCTestCase {
    static var allTests = [
        ("testAsin", testAsin),
        ("testFloatAsin", testFloatAsin),
        ("testCGFloatAsin", testCGFloatAsin),
        ("testAsinThrowing", testAsinThrowing),
        ("testAcos", testAcos),
        ("testFloatAcos", testFloatAcos),
        ("testCGFloatAcos", testCGFloatAcos),
        ("testAcosThrowing", testAcosThrowing),
        ("testAtan", testAtan),
        ("testAtanFloat", testAtanFloat),
        ("testAtanCGFloat", testAtanCGFloat),
        ("testAtanMinusInfinity", testAtanMinusInfinity),
        ("testAtanInfinity", testAtanInfinity),
        ("testAtan2", testAtan2),
        ("testAtan2Float", testAtan2Float),
        ("testAtan2CGFloat", testAtan2CGFloat),
        ("testAtan2MinusInfinityMinusInfinity", testAtan2MinusInfinityMinusInfinity),
        ("testAtan2MinusInfinityInfinity", testAtan2MinusInfinityInfinity),
        ("testAtan2InfinityMinusInfinity", testAtan2InfinityMinusInfinity),
        ("testAtan2InfinityInfinity", testAtan2InfinityInfinity)
    ]
