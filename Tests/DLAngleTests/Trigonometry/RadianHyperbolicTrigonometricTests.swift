...
class RadianHyperbolicTrigonometricTests: XCTestCase {
    static var allTests = [
        ...
        ("testSinhCGFloat", testSinhCGFloat),
        ("testSinhMinusInfinity", testSinhMinusInfinity),
        ("testSinhInfinity", testSinhInfinity),
        ("testCosh", testCosh),
        ("testCoshFloat", testCoshFloat),
        ("testCoshCGFloat", testCoshCGFloat),
        ("testCoshMinusInfinity", testCoshMinusInfinity),
        ("testCoshInfinity", testCoshInfinity),
        ("testTanh", testTanh),
        ("testTanhFloat", testTanhFloat),
        ("testTanhCGFloat", testTanhCGFloat),
        ("testTanhMinusInfinity", testTanhMinusInfinity),
        ("testTanhInfinity", testTanhInfinity),
        ("testCoth", testCoth),
        ("testCothFloat", testCothFloat),
        ("testCothCGFloat", testCothCGFloat),
        ("testCothThrowing", testCothThrowing),
        ("testCothMinusInfinity", testCothMinusInfinity),
        ("testCothInfinity", testCothInfinity),
        ("testSech", testSech),
        ("testSechFloat", testSechFloat),
        ("testSechCGFloat", testSechCGFloat),
        ("testSechMinusInfinity", testSechMinusInfinity),
        ("testSechInfinity", testSechInfinity),
        ("testCsch", testCsch),
        ("testCschFloat", testCschFloat),
        ("testCschCGFloat", testCschCGFloat),
        ("testCschThrowing", testCschThrowing),
        ("testCschMinusInfinity", testCschMinusInfinity),
        ("testCschInfinity", testCschInfinity)
    ]
