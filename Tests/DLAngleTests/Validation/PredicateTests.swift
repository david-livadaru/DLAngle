...
class PredicateTests: XCTestCase {
    static var allTests = [
        ("testClosurePredicate", testClosurePredicate),
        ("testArrayPredicateForSuccess", testArrayPredicateForSuccess),
        ("testArrayPredicateForFailure", testArrayPredicateForFailure),
        ("testIntervalPredicate", testIntervalPredicate),
        ("testNotPredicate", testNotPredicate),
        ("testAndPredicateForSuccess", testAndPredicateForSuccess),
        ("testAndPredicateForFailure", testAndPredicateForFailure),
        ("testOrPredicateForSuccess", testOrPredicateForSuccess),
        ("testOrPredicateForFailure", testOrPredicateForFailure)
    ]
