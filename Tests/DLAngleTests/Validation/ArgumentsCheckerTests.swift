...
class ArgumentsCheckerTests: XCTestCase {
    static var allTests = [
        ...
        ("testValidValues2", testValidValues2),
        ("testValidRange", testValidRange),
        ("testValidRange2", testValidRange2),
        ("testInvalidValues", testInvalidValues),
        ("testInvalidValues2", testInvalidValues2),
        ("testInvalidValues3", testInvalidValues3),
        ("testInvalidValues4", testInvalidValues4),
        ("testInvalidRange", testInvalidRange),
        ("testInvalidRange2", testInvalidRange2)
    ]
